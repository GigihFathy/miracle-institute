<footer class="bg-[#004777] text-slate-300 pt-6">
    <div class="grid grid-cols-1 gap-10 px-4 py-12 sm:px-5 lg:px-20 xl:px-46 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
            <h3 class="mb-4 font-semibold text-white">{{ __('general.footer.navigation.title') }}</h3>
            <ul class="space-y-2 text-sm">
                ...
                @auth
                    ...
                    <li><a href="{{ localized_route('certificates.index') }}" class="hover:text-white">{{ __('general.navigation.certificates') }}</a></li>
                @endauth
            </ul>
        </div>
                    ...
                    <li>
                        <a href="https://wa.me/{{ $company->whatsapp }}"
                           ...
                           class="hover:text-white">
                            {{ __('general.footer.contact.whatsapp') }}
                        </a>
                    </li>
                @endif
