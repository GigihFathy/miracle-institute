@component('emails.layouts.learning', [
    ...
    <p style="margin:0 0 16px 0;">
        Enrollment Anda untuk course berikut sudah berhasil diproses.
    </p>

    <p style="margin:0 0 6px 0;"><strong>Course:</strong> {{ $enrollment->course->title }}</p>
    ...
    <p style="margin:0 0 16px 0;">
        Anda sudah bisa mulai belajar dan melihat progres pembelajaran dari halaman course.
    </p>
