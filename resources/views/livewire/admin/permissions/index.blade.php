                            ...
                            <tr class="transition-colors hover:bg-slate-50/60">
                                ...
                                <td class="px-4 py-3">
                                    {{-- <div class="flex justify-end gap-2">
                                        ...
                                        <div class="relative group">
                                            <button wire:click="confirmDelete('{{ $row->id }}')" class="admin-delete-button inline-flex h-9 w-9 items-center justify-center rounded-lg transition" title="{{ __('admin.permissions.actions.delete') }}">
