...
return [
    ...
    | class validator. Beberapa rule memiliki beberapa versi, seperti rule
    ...
    */
    ...
    'missing_if' => 'Kolom :attribute harus tidak ada saat :other bernilai :value.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Kata sandi :attribute yang diberikan telah muncul dalam kebocoran data. Silakan pilih :attribute lain.',
    ],
    ...
    'prohibited_if' => 'Kolom :attribute dilarang saat :other bernilai :value.',
    ...
    'size' => [
        'array' => 'Kolom :attribute harus terdiri dari :size item.',
    ...
    | konvensi "attribute.rule" untuk menamai barisnya. Ini memudahkan Anda
    | untuk membuat pesan khusus bagi rule tertentu.
    |
    */
    ...
    | istilah yang lebih ramah pembaca, misalnya "Alamat Email" alih-alih
