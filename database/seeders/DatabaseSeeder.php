...
class DatabaseSeeder extends Seeder
{
    ...
    private function seedStudentStudyProgram($now): array
    {
        $program = [
            ...
            'description' => 'Program pembelajaran pemuridan yang menolong peserta bertumbuh dalam identitas, karakter, pelayanan, dan pengutusan.',
            'status' => 'active',
            'created_at' => $now,
            'updated_at' => $now,
        ];
        ...
        foreach ($assessmentPayloads as $courseIndex => $payload) {
            ...
            for ($questionNumber = 1; $questionNumber <= 5; $questionNumber++) {
                ...
                $questions[] = [
                    ...
                    'question_type' => 'mcq',
                    'question' => 'Dalam ' . $payload['course_title'] . ', apa inti pembelajaran pemuridan pada soal nomor ' . $questionNumber . '?',
